...
<head>
  ...
  .profile-userpic img {
    ...
    .profile-usertitle {
      ...
      <body onload="del()">
         ...
         <div class="container-fluid" style="position: fixed;z-index: 1;">
          ...
          <div class="row" style="width: 250%;margin-left: -73px;margin-top: -20px;z-index: -1;">
            ...
            <div class="col-lg-12" style="background: #f1f4f7;padding-top: 20px;padding-left: 40px;">
              <h2 class="page-header">Question Bank</h2>
            </div>
          </div>
        ...
        <div class="container-fluid" style="margin-top: 5px;margin-left: -42px;margin-right:42px;background: #fff;min-height: 450px;width: 107%;z-index: -1;color: #000;">
          ...
          <form name="mock" action="/ProgramTap/Question/mockSet.php" method="GET">
            <input type="hidden" name="pagename" value="News">
            <input type="hidden" name="elmnt" value="this">
            <input type="hidden" name="k" value="1">




          <button class="btn btn-primary" type="submit">ADD Theory MOCK QUESTIONS</button>
          <button class="btn btn-primary" type="button" onclick="addpractical()">ADD Practical MOCK QUESTIONS</button>
        </form>
   ...
   window.location.replace("/ProgramTap/Question/practical_question.php");
   }
