      ...
      <body>
        ...
        <div class="wrapper">
          ...
          <nav id="sidebar">
            ...
            <li class="active"><a href="indexadmin.php" style="padding: 15px;background: #30a5ff;font-size: 15px;font-weight: 300;"><em class="glyphicon glyphicon-home">&nbsp;</em> Home</a></li> 
            <li class="other"><a href="examName.php"><em class="fa fa-calendar">&nbsp;</em> Exam Schedule</a></li>
            <li class="other"><a href="AdminStudent.php"><em class="glyphicon glyphicon-stats">&nbsp;</em> Results</a></li>
            <li class="other"><a href="/project2/ad/AdminExams.php"><em class="fa fa-toggle-off">&nbsp;</em>  Exams</a></li>
            <li class="other"><a href="AddQues.php"><em class="fa fa-clone">&nbsp;</em> Question Bank</a></li>
            <li class="parent ">
            </li>
            <li class="other"><a href="/project2/index.php"><em class="fa fa-power-off">&nbsp;</em> Logout</a></li>
          </ul>
