      ...
      <body>
        ...
        <div class="wrapper">
          ...
          <nav id="sidebar">
            ...
            <li class="active"><a href="/ProgramTap/Exam/AdminExams.php" style="padding: 15px;background: #30a5ff;font-size: 15px;font-weight: 300;"><em class="fa fa-toggle-off">&nbsp;</em> Exams</a></li>
            ...
            <table id="example" class="table table-bordered table-responsive">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th style="text-align: center">Duration(in min)</th>
                  <th style="text-align: center">No of Ques.</th>

                  <th style="text-align: center">Status</th>
                  <th style="text-align: center">View Students</th>
                  <th style="text-align: center">View Questions</th>

                  <!--<th style="text-align: center">View Report</th>-->
                  <th style="text-align: center">More Action</th>
                  <!--<th style="text-align: center">Schedule Exam</th>-->
                </tr>
              </thead>
              <?php
              /*$query="select * from exam";*/
              $query="select DISTINCT e.eid,e.ename,e.date,e.noq,e.duration,se.e_status from exam e join s_exam se ON (e.eid = se.eid) where e.date IS NOT NULL AND e.duration IS NOT NULL";
              $crud->examview($query);
              ?>
