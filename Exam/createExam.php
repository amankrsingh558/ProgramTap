         ...
         <div class="container-fluid" style="position: fixed;z-index: 1;">
          ...
          <div class="row" style="margin-top: -70px!important;margin-left: -80px; width: 1200px;position: fixed;">
            <ol class="breadcrumb">
              ...
              <li class="active"><a href="/ProgramTap/Question/examName.php">Schedule Exam</a>/New Exam</li>
            </ol>
          </div><!--/.row-->
          </div>
          <div class="row" style="width: 250%;margin-left: -73px;position: fixed;margin-top: -20px;z-index: -1;">

            <div class="col-lg-12" style="background: #f1f4f7;padding-top: 20px;padding-left: 50px;">
              <h2 class="page-header">New Exam</h2>
            </div>
          </div>


        
        <div class="container-fluid" style="margin-top: 60px;margin-left: -42px;margin-right:42px;background: #f1f4f7; min-height: 450px;width: 107%;color: #000;z-index: -1;">
          ...
          <div class="container" style="width: 100%;">
           ...
           <form action="/ProgramTap/Exam/saveExam.php" method="get" onsubmit="return validateForm()" name="ecreate">
            ...
            <select placeholder="Choose a Type..." name="type" class="form-group col-lg-2" style="padding: 10px;font-size: 12px;margin-top: 48px;"  >
            ...
            <input id="ename" name="ename" type="text" class="form-control" placeholder="Enter Exam Name" style="width: 250px;margin-top: 50px;margin-left: 20px;" />
          </div>

            <div class="form-group col-lg-3" >
            <input id="num" name="num" type="number" min="1" class="form-control" placeholder="Enter number of questions" style="width: 250px;margin-top: 50px;" />
          </div>
            ...
            <input type="submit" class="btn btn-success" name="submit" value="Create Exam" style="float: right;margin-right: 70px;">
