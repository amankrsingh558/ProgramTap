...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">C Programming Language</h1>
			</div>
		</div><!--/.row-->
		
		<div class="panel panel-container">
			<div class="row">
				<div class="col-xs-6 col-md-4 col-lg-4 no-padding" style="height: 350px">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding">
							<div class="large"></div>
							<a href="Tutorial.php"><div><img src="learn.jpg" style="height: 60%;width: 60%;"></div><br>
							<div style="text-decoration: none;color: black;font-size:20px;"><b>Tutorials</b></div></a>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-4 col-lg-4 no-padding" style="height: 300px">
					<div class="panel panel-blue panel-widget border-right">
						<div class="row no-padding">
							<div class="large">
							</div>
							<a href="Practical.php"><div><img src="code.jpg" style="height: 60%;width: 60%;"></div><br>
							<div style="text-decoration: none;color: black;font-size:20px;"><b>Practical</b></div></a>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-4 col-lg-4 no-padding" style="height: 300px">
					<div class="panel panel-blue panel-widget border-right">
						<div class="row no-padding">
							...
							<a href="MCQs.php"><div><img src="mcq.jpg" style="height: 60%;width: 60%;"></div><br>
							<div style="text-decoration: none;color: black; font-size:20px;"><b>Mock MCQs</b></div></a>
						</div>
					</div>
				</div>
