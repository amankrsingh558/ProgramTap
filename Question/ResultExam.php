  ...
  <div class="container-fluid" style="width: 100%;height: 70px;background: #2c3e50;opacity: 1;color: white;border-bottom: 0.5px solid white;position: fixed;z-index: 1;"> 
        ...
        <div class="wrapper">
          ...
          <nav id="sidebar">
            ...
            <li class="active"><a href="/ProgramTap/Question/ResultExam.php" style="padding: 15px;background: #30a5ff;font-size: 15px;font-weight: 300;"><em class="fa fa-bar-chart">&nbsp;</em> Results</a></li>
        ...
        <!-- Page Content  -->
        <div id="content" style="margin-top: 80px; background: #fff;color: #000;">
...
<form id="fm" action="" method="" >
     

     <div class="form-group col-lg-2" style="padding-top: 25px;">
    <select class="form-control form-control-lg" style="background-color:#fff" value="Exam Name"  id="en" onchange="" name="examselect" required>
  <option value="" >Select Exam</option>
       <?php
     
        $today = date("Y-m-d");
$sql="SELECT * from exam where ready=1";
...
?>
     ...
     <div class="form-group col-lg-2" style="padding-top: 25px;">
    <select class="form-control form-control-lg" style="background-color:#fff" id="br"  onchange=""  name="branchselect">
  ...
  <option value="" >Select Branch</option>
    ...
    <option value="CE">CE</option>
     ...
     <div class="form-group col-lg-2" style="padding-top: 25px;">
    <select class="form-control form-control-lg" style="background-color:#fff" id="yr" onchange="" name="yearselect">
...
<div class="form-group col-lg-2" style="padding-top: 25px;">
  <input  class="btn btn-success " type="button" onclick="validate()" id="bbb" value="Submit">
   </div>
 </form>
 ...
 if (document.getElementById('en').value =="") 
    alert('Select Atleast One Exam Name');
else{
  
  
    var name = document.getElementById('en').value;
    var branch=document.getElementById('br').value;
    var year=document.getElementById('yr').value;
var url = "ResultExamList.php";
        $.ajax({
            url: url,
            type: 'POST',
            data: {'examselect':name,'branchselect':branch,'yearselect':year},
